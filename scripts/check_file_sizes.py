...
BACKEND_ACK = {
    ...
    "knot/api/query.py":                   517,  # SSE 协议样板不可消除（v0.5.2 R-94）+ v0.7.1 语义路由 440→460 + v0.7.3 审计侧表 460→465 + v0.7.20 A presenter 失败 gate + v0.7.24 A1 history dict +explanation/agent_kind 485→487 + v0.7.35 B1.2 SSE emit-scrub + sql_step suppress + 同步端点旁路脱敏 490→517（alias_map fail-open 收口 desensitize.non_admin_alias_map）
