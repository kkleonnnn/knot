...
BACKEND_ACK = {
    ...
    "knot/services/semantic/compiler.py":  355,  # v0.7.11 确定性编译器核心（单/跨对象/基数/HAVING/窗口/分区top-N/多base标量）；资深拍 C 留 compiler+ACK bump（CompileError 外部契约 + 承重刀少动件；0 循环 import）
