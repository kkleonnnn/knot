...
LIMITS = {
    ...
    "frontend/src/Shared.jsx":                     720,  # v0.6.2.4 drift 调和再增 ~10 export（PATCH-1 560→720；headroom for btn/input 族 lift + Avatar + theadStyle + PeriodTab/TagChip/statLabelStyle 参数化）
