...
echo "    都改为 'from bi_agent.X.Y import Z' 绝对路径"
...
echo "    from bi_agent.repositories.user_repo import get_user_by_id"
echo "    from bi_agent.repositories.settings_repo import get_app_setting"
echo "    ...等 (按 *_repo.py 模块化访问)"
echo ""
echo "v0.3.1 起将删除 bi_agent.repositories 包级的 facade re-export，"
