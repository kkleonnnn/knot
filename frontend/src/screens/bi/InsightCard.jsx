...
export function InsightCard({ T, text }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 11, color: T.accent, fontWeight: 650, marginBottom: 6 }}>
      ...
      <div style={{ fontSize: 13, color: T.subtext, lineHeight: 1.7 }}>{text}</div>
    </div>
  );
}
