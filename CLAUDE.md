...
| ⏳ v0.5.7+ | (C5+) Claude Design UI 重构（屏复刻多 PATCH）| 1 屏 1 PATCH 渐进替换 18 个 artboards（home/thinking/login/shell/9 admin tabs/3 logo 展示）；可独立打开 `knot_ui_demo/v0.5/artboards/*.jsx` 参考视觉 |
