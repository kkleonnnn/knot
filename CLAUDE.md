...
> **执行序（资深 2026-06-20 选项 1 LOCKED）**：① type-hint 统一（**✅ v0.6.5.10**）→ ② admin.py 拆 + check_file_sizes 根治（**✅ v0.6.5.11**）→ ③ catalog.py 高守护（完整 v3）→ v0.7.0 C1。sync 链删除 / http_planner futures 下沉 JIT 推迟到相关 v0.7.x。
