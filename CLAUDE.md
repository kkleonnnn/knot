...
| ⏳ v0.5.10+ | (C5+) Claude Design UI 重构（屏复刻多 PATCH）| 1 屏 1 PATCH 渐进替换剩余 16 屏（home / thinking / favorites / 9 admin tabs / database / knowledge / catalog / sql-lab / settings / conversations）；执行模板由 v0.5.7 Login pilot + v0.5.9 Shell 双 pilot 确立；视觉复刻通用约束由 v0.5.8 § Visual Replication Protocol 锁定 |
