"""knot/scripts/purge_audit_log.py — 审计 retention 清理脚本（v0.4.6 commit #5）。

执行：
    python3 -m knot.scripts.purge_audit_log [--dry-run]
...
from knot.repositories import base as _base_mod  # 调用时读 SQLITE_DB_PATH（兼容测试 monkeypatch）
