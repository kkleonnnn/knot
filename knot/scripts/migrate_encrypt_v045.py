"""knot/scripts/migrate_encrypt_v045.py — 一次性数据加密迁移（v0.4.5 commit #3）。

执行：
    python3 -m knot.scripts.migrate_encrypt_v045 [--dry-run]
...
from knot.core.crypto import encrypt, is_encrypted
