...
from . import api_keys, budgets, datasources, logicform, metrics, models, monitors, or_catalog, stats, users
...
router = APIRouter()
for _sub in (users, datasources, models, api_keys, budgets, stats, or_catalog, metrics, logicform, monitors):
