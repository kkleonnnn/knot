...
from . import api_keys, budgets, datasources, metrics, models, or_catalog, stats, users
...
router = APIRouter()
for _sub in (users, datasources, models, api_keys, budgets, stats, or_catalog, metrics):
