...
class AgentResult:
    ...
    # v0.7.23/.25 呈现（additive 默认空；语义路径填，LLM/sync/fix 既有构造 byte-equal · R-SL-168）
    ...
    column_formats: dict = field(default_factory=dict)  # {metric.name: unit}（percentage 渲染 #1 · R-SL-181；空 unit 不入）
